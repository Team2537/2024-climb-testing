...
class UpCommand : Command() {
    override fun initialize() {
        ...
        PIDSubsystem.rightMotor.set(.3)
        //PIDSubsystem.rightMotor.pidController.setReference(1.0, CANSparkBase.ControlType.kVelocity)
    }
    ...
    override fun isFinished(): Boolean {
        ...
        //return abs(PIDSubsystem.rightMotor.encoder.position - 1.0) <= 0.1
        return false
    }
